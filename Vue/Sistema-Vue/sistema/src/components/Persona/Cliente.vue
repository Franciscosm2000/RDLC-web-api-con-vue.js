    ...
    <v-layout align-start>
        <v-flex>
            ...
            <v-toolbar flat color="white">
                <v-toolbar-title><v-icon>ballot</v-icon> Clientes</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
                                ...
                                <v-row>
                                    ...
                                    >
                                        <v-chip
                                            ...
                                            >
                                            <span>Código :
                                             <label v-text="id_cliente"></label></span>
    ...
    export default {
        ...
        methods:{
            ...
            listar(){
                ...
                axios.get('api/Clientes/Listar/as',configuracion).then(function(response){
