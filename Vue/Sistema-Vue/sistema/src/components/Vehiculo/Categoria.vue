    ...
    <v-layout align-start>
        <v-flex>
            ...
            <v-toolbar flat color="white">
                <v-toolbar-title><v-icon>ballot</v-icon> Categorias de vehiculo</v-toolbar-title>
                    <v-divider
                    class="mx-2"
                    inset
                    vertical
                            ...
                            <v-container>
                                <v-row>
                                    ...
                                    >
                                        ...
                                        label="Nombre"
                                        hint="Ejemplo: Carro liviano, Camioneta, etc"
                                        required
                                        >
                                            <v-icon slot="prepend"
                                             color="light-blue darken-3">subject</v-icon>
                                        </v-text-field>
                                    </v-col>
    ...
    export default {
        data(){
            return {
                ...
                headers: [
                    ...
                    { text: 'id_categoria', value: 'id_categoria'},
        ...
        methods:{
            ...
            listar(){
                ...
                axios.get('api/Categorias/Listar/s',configuracion).then(function(response){
            ...
            validar(){
                ...
                if(!this.nombre){
                    this.validaMensaje.push("El nombre es un campo obligatorio.");
                }
            ...
            activarDesactivarMostrar(accion,item){
                ...
                this.adIdTipo=item.id_categoria;
                if (accion==1){
                    this.adAccion=1;
                }
                else if (accion==2){
            ...
            activar(){
                ...
                let header={"Authorization" : "Bearer " + this.$store.state.token};
                let configuracion= {headers : header};
                axios.put('api/Categorias/Activar/'+this.adIdTipo+'/'+this.usuario,{},configuracion).then(function(response){
            ...
            desactivar(){
                ...
                let header={"Authorization" : "Bearer " + this.$store.state.token};
                let configuracion= {headers : header};
                axios.put('api/Categorias/Desactivar/'+this.adIdTipo+'/'+this.usuario,{},configuracion).then(function(response){
                    me.adModalDesactivar=0;
                    me.adAccion=0;
                    me.adIdTipo="";
                    me.listar();
